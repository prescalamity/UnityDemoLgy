...
public class TMPro_TMP_DropdownWrap
{
	...
	{
		L.BeginClass(typeof(TMPro.TMP_Dropdown), typeof(UnityEngine.MonoBehaviour), "TMP_Dropdown");
		...
		L.RegFunction("SelectedText", SelectedText);
		L.EndClass();
	}


	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SelectedText(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			TMPro.TMP_Dropdown obj = (TMPro.TMP_Dropdown)ToLua.CheckObject(L, 1, typeof(TMPro.TMP_Dropdown));
			ToLua.Push(L, obj.options[obj.value].text);
			return 1;
		}
		catch (Exception e)
		{
	...
	static Type classType = typeof(TMPro.TMP_Dropdown);
	...
	static int AddOptions(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(TMPro.TMP_Dropdown), typeof(System.Collections.Generic.List<TMPro.TMP_Dropdown.OptionData>)))
			{
				TMPro.TMP_Dropdown obj = (TMPro.TMP_Dropdown)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(TMPro.TMP_Dropdown), typeof(System.Collections.Generic.List<string>)))
			{
				TMPro.TMP_Dropdown obj = (TMPro.TMP_Dropdown)ToLua.ToObject(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(TMPro.TMP_Dropdown), typeof(System.Collections.Generic.List<UnityEngine.Sprite>)))
			{
				TMPro.TMP_Dropdown obj = (TMPro.TMP_Dropdown)ToLua.ToObject(L, 1);
	...
	static int get_IsExpanded(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index IsExpanded on a nil value" : e.Message);
		}
	}
	...
	static int set_onValueChanged(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			TMPro.TMP_Dropdown obj = (TMPro.TMP_Dropdown)o;
			TMPro.TMP_Dropdown.DropdownEvent arg0 = (TMPro.TMP_Dropdown.DropdownEvent)ToLua.CheckObject(L, 2, typeof(TMPro.TMP_Dropdown.DropdownEvent));
