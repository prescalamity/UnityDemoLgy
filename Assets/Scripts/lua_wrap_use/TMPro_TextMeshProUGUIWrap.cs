...
public class TMPro_TextMeshProUGUIWrap
{
	...
	static Type classType = typeof(TMPro.TextMeshProUGUI);
	...
	{
		ToLua.Push(L, new EventObject("TMPro.TextMeshProUGUI.OnPreRenderText"));
		return 1;
	}
	...
	static int set_OnPreRenderText(IntPtr L)
	{
		try
		{
			...
			{
				System.Action<TMPro.TMP_TextInfo> ev = (System.Action<TMPro.TMP_TextInfo>)LuaMisc.GetEventHandler(obj, typeof(TMPro.TextMeshProUGUI), "OnPreRenderText");
