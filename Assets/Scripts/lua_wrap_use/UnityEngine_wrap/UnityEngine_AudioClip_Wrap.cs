	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			else if (count == 6)
			{
				...
				{
					 arg5 = (UnityEngine.AudioClip.PCMReaderCallback)ToLua.CheckObject(L, 6, typeof(UnityEngine.AudioClip.PCMReaderCallback));
				}
				else
				{
			...
			else if (count == 7)
			{
				...
				{
					 arg6 = (UnityEngine.AudioClip.PCMSetPositionCallback)ToLua.CheckObject(L, 7, typeof(UnityEngine.AudioClip.PCMSetPositionCallback));
				}
				else
				{
