...
public class UnityEngine_FontWrap
{
	...
	static Type classType = typeof(UnityEngine.Font);
	...
	static int CreateDynamicFontFromOSFont(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.Font.CreateDynamicFontFromOSFont");
#endif
			int count = LuaDLL.lua_gettop(L);
	...
	static int GetMaxVertsForString(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.GetMaxVertsForString");
#endif
	...
	static int HasCharacter(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.HasCharacter");
#endif
	...
	static int GetOSInstalledFontNames(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.GetOSInstalledFontNames");
#endif
	...
	static int GetPathsToOSFonts(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.GetPathsToOSFonts");
#endif
			ToLua.CheckArgsCount(L, 0);
	...
	static int GetCharacterInfo(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.GetCharacterInfo");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 5)
			{
				...
				UnityEngine.CharacterInfo arg1;
				int arg2 = (int)LuaDLL.luaL_checknumber(L, 4);
				UnityEngine.FontStyle arg3 = (UnityEngine.FontStyle)LuaDLL.luaL_checknumber(L, 5);
	...
	static int RequestCharactersInTexture(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.RequestCharactersInTexture");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 4)
			{
				...
				string arg0 = ToLua.CheckString(L, 2);
				int arg1 = (int)LuaDLL.luaL_checknumber(L, 3);
				UnityEngine.FontStyle arg2 = (UnityEngine.FontStyle)LuaDLL.luaL_checknumber(L, 4);
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.op_Equality");
#endif
			ToLua.CheckArgsCount(L, 2);
	...
	static int get_material(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.material");
#endif
	...
	static int get_fontNames(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.fontNames");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
	...
	static int get_dynamic(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.dynamic");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
	...
	static int get_ascent(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.ascent");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
			int ret = obj.ascent;
	...
	static int get_fontSize(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.fontSize");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
	...
	static int get_characterInfo(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.characterInfo");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
	...
	static int get_lineHeight(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Font.lineHeight");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Font obj = (UnityEngine.Font)o;
