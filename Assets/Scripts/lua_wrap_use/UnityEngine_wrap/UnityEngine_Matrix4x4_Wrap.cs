...
public class UnityEngine_Matrix4x4Wrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.Matrix4x4), typeof(System.Object), "Matrix4x4");
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.Matrix4x4.get_Item");
#endif
	...
	static int _set_this(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.set_Item");
#endif
	...
	static Type classType = typeof(UnityEngine.Matrix4x4);
	...
	static int ValidTRS(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.ValidTRS");
#endif
	...
	static int Determinant(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Determinant");
#endif
			ToLua.CheckArgsCount(L, 1);
	...
	static int TRS(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.TRS");
#endif
			ToLua.CheckArgsCount(L, 3);
	...
	static int SetTRS(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.SetTRS");
#endif
	...
	static int Inverse3DAffine(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Inverse3DAffine");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 arg0 = StackTraits<UnityEngine.Matrix4x4>.Check(L, 1);
	...
	static int Inverse(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Inverse");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Matrix4x4 arg0 = StackTraits<UnityEngine.Matrix4x4>.Check(L, 1);
	...
	static int Transpose(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Transpose");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Matrix4x4 arg0 = StackTraits<UnityEngine.Matrix4x4>.Check(L, 1);
	...
	static int Ortho(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Ortho");
#endif
	...
	static int Perspective(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Perspective");
#endif
			ToLua.CheckArgsCount(L, 4);
			float arg0 = (float)LuaDLL.luaL_checknumber(L, 1);
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 2);
	...
	static int LookAt(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.LookAt");
#endif
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 1);
	...
	static int Frustum(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Frustum");
#endif
			int count = LuaDLL.lua_gettop(L);
	...
	static int GetHashCode(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.GetHashCode");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
	...
	static int Equals(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Equals");
#endif
			int count = LuaDLL.lua_gettop(L);

			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Matrix4x4), typeof(UnityEngine.Matrix4x4)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Matrix4x4), typeof(object)))
			{
				UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.ToObject(L, 1);
	...
	static int op_Multiply(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.op_Multiply");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Matrix4x4), typeof(UnityEngine.Vector4)))
			{
				UnityEngine.Matrix4x4 arg0 = StackTraits<UnityEngine.Matrix4x4>.To(L, 1);
				UnityEngine.Vector4 arg1 = ToLua.ToVector4(L, 2);
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.op_Equality");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 arg0 = StackTraits<UnityEngine.Matrix4x4>.To(L, 1);
			UnityEngine.Matrix4x4 arg1 = StackTraits<UnityEngine.Matrix4x4>.To(L, 2);
	...
	static int GetColumn(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.GetColumn");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
	...
	static int GetRow(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.GetRow");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
	...
	static int GetPosition(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.GetPosition");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
	...
	static int SetColumn(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.SetColumn");
#endif
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
	...
	static int SetRow(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.SetRow");
#endif
			ToLua.CheckArgsCount(L, 3);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
	...
	static int MultiplyPoint(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.MultiplyPoint");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
	...
	static int MultiplyPoint3x4(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.MultiplyPoint3x4");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
	...
	static int MultiplyVector(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.MultiplyVector");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
	...
	static int TransformPlane(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.TransformPlane");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
	...
	static int Scale(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Scale");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 1);
	...
	static int Translate(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Translate");
#endif
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 1);
	...
	static int Rotate(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.Rotate");
#endif
			ToLua.CheckArgsCount(L, 1);
	...
	static int ToString(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.ToString");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 3)
			{
				UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
				string arg0 = ToLua.CheckString(L, 2);
				System.IFormatProvider arg1 = (System.IFormatProvider)ToLua.CheckObject(L, 3, typeof(System.IFormatProvider));
	...
	static int get_m00(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m00");
#endif
	...
	static int get_m10(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m10");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m10;
	...
	static int get_m20(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m20");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m20;
	...
	static int get_m30(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m30");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m30;
	...
	static int get_m01(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m01");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m01;
	...
	static int get_m11(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m11");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m11;
	...
	static int get_m21(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m21");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m21;
	...
	static int get_m31(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m31");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m31;
	...
	static int get_m02(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m02");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m02;
	...
	static int get_m12(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m12");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m12;
	...
	static int get_m22(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m22");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m22;
	...
	static int get_m32(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m32");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m32;
	...
	static int get_m03(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m03");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m03;
	...
	static int get_m13(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m13");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m13;
	...
	static int get_m23(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m23");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m23;
	...
	static int get_m33(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.m33");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
			float ret = obj.m33;
	...
	static int get_rotation(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.rotation");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
	...
	static int get_lossyScale(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.lossyScale");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
	...
	static int get_isIdentity(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.isIdentity");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
	...
	static int get_decomposeProjection(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.Matrix4x4.decomposeProjection");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)o;
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index decomposeProjection on a nil value" : e.Message);
		}
	}
