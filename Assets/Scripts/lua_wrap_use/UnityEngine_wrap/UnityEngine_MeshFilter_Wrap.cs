...
public class UnityEngine_MeshFilterWrap
{
	...
	static Type classType = typeof(UnityEngine.MeshFilter);
	...
	static int op_Equality(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.MeshFilter.op_Equality");
#endif
	...
	static int get_sharedMesh(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.MeshFilter.sharedMesh");
#endif
	...
	static int get_mesh(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.MeshFilter.mesh");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.MeshFilter obj = (UnityEngine.MeshFilter)o;
