...
public class UnityEngine_RectTransformWrap
{
	...
	static Type classType = typeof(UnityEngine.RectTransform);
	...
	static int SetInsetAndSizeFromParentEdge(IntPtr L)
	{
		try
		{
			...
			UnityEngine.RectTransform obj = (UnityEngine.RectTransform)ToLua.CheckObject(L, 1, typeof(UnityEngine.RectTransform));
			UnityEngine.RectTransform.Edge arg0 = (UnityEngine.RectTransform.Edge)LuaDLL.luaL_checknumber(L, 2);
	...
	static int SetSizeWithCurrentAnchors(IntPtr L)
	{
		try
		{
			...
			UnityEngine.RectTransform obj = (UnityEngine.RectTransform)ToLua.CheckObject(L, 1, typeof(UnityEngine.RectTransform));
			UnityEngine.RectTransform.Axis arg0 = (UnityEngine.RectTransform.Axis)LuaDLL.luaL_checknumber(L, 2);
			float arg1 = (float)LuaDLL.luaL_checknumber(L, 3);
