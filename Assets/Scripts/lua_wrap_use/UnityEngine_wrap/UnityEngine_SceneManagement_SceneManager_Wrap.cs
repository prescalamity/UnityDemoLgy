...
public class UnityEngine_SceneManagement_SceneManagerWrap
{
	...
	static int GetActiveScene(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.GetActiveScene");
#endif
	...
	static int SetActiveScene(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.SetActiveScene");
#endif
	...
	static int GetSceneByPath(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.GetSceneByPath");
#endif
			ToLua.CheckArgsCount(L, 1);
	...
	static int GetSceneByName(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.GetSceneByName");
#endif
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
	...
	static int GetSceneByBuildIndex(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.GetSceneByBuildIndex");
#endif
			ToLua.CheckArgsCount(L, 1);
	...
	static int GetSceneAt(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.GetSceneAt");
#endif
			ToLua.CheckArgsCount(L, 1);
			int arg0 = (int)LuaDLL.luaL_checknumber(L, 1);
	...
	static int CreateScene(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.CreateScene");
#endif
			int count = LuaDLL.lua_gettop(L);
	...
	static int MergeScenes(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.MergeScenes");
#endif
	...
	static int MoveGameObjectToScene(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.MoveGameObjectToScene");
#endif
			ToLua.CheckArgsCount(L, 2);
	...
	static int LoadScene(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.LoadScene");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			{
				string arg0 = ToLua.ToString(L, 1);
				UnityEngine.SceneManagement.LoadSceneMode arg1 = (UnityEngine.SceneManagement.LoadSceneMode)LuaDLL.luaL_checknumber(L, 2);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(UnityEngine.SceneManagement.LoadSceneParameters)))
			{
				string arg0 = ToLua.ToString(L, 1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(UnityEngine.SceneManagement.LoadSceneParameters)))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.SceneManagement.LoadSceneParameters arg1 = StackTraits<UnityEngine.SceneManagement.LoadSceneParameters>.To(L, 2);
				UnityEngine.SceneManagement.Scene o = UnityEngine.SceneManagement.SceneManager.LoadScene(arg0, arg1);
	...
	static int LoadSceneAsync(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.LoadSceneAsync");
#endif
			int count = LuaDLL.lua_gettop(L);
	...
	static int UnloadSceneAsync(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync");
#endif
			int count = LuaDLL.lua_gettop(L);
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.SceneManagement.Scene)))
			{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(int), typeof(UnityEngine.SceneManagement.UnloadSceneOptions)))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.SceneManagement.UnloadSceneOptions arg1 = (UnityEngine.SceneManagement.UnloadSceneOptions)LuaDLL.luaL_checknumber(L, 2);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(string), typeof(UnityEngine.SceneManagement.UnloadSceneOptions)))
			{
				string arg0 = ToLua.ToString(L, 1);
				UnityEngine.SceneManagement.UnloadSceneOptions arg1 = (UnityEngine.SceneManagement.UnloadSceneOptions)LuaDLL.luaL_checknumber(L, 2);
				UnityEngine.AsyncOperation o = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync(arg0, arg1);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.SceneManagement.Scene), typeof(UnityEngine.SceneManagement.UnloadSceneOptions)))
			{
				UnityEngine.SceneManagement.Scene arg0 = StackTraits<UnityEngine.SceneManagement.Scene>.To(L, 1);
				UnityEngine.SceneManagement.UnloadSceneOptions arg1 = (UnityEngine.SceneManagement.UnloadSceneOptions)LuaDLL.luaL_checknumber(L, 2);
				UnityEngine.AsyncOperation o = UnityEngine.SceneManagement.SceneManager.UnloadSceneAsync(arg0, arg1);
