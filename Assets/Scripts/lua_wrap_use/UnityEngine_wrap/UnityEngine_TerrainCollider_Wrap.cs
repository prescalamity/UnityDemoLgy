...
public class UnityEngine_TerrainColliderWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.TerrainCollider), typeof(UnityEngine.Collider), "TerrainCollider");
	...
	static Type classType = typeof(UnityEngine.TerrainCollider);
	...
	static int op_Equality(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.TerrainCollider.op_Equality");
#endif
	...
	static int get_terrainData(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.TerrainCollider.terrainData");
#endif
