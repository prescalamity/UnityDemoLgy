...
public class UnityEngine_TextAssetWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.TextAsset), typeof(UnityEngine.Object), "TextAsset");
	...
	static Type classType = typeof(UnityEngine.TextAsset);
	...
	static int ToString(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.TextAsset.ToString");
#endif
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.TextAsset.op_Equality");
#endif
	...
	static int get_bytes(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.TextAsset.bytes");
#endif
	...
	static int get_text(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.TextAsset.text");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.TextAsset obj = (UnityEngine.TextAsset)o;
			string ret = obj.text;
	...
	static int get_dataSize(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.TextAsset.dataSize");
#endif
			o = ToLua.ToObject(L, 1);
			UnityEngine.TextAsset obj = (UnityEngine.TextAsset)o;
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index dataSize on a nil value" : e.Message);
		}
	}
}
