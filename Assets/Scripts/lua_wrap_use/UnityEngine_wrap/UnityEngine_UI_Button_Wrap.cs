...
public class UnityEngine_UI_ButtonWrap
{
	...
	{
		L.BeginClass(typeof(UnityEngine.UI.Button), typeof(UnityEngine.MonoBehaviour), "Button");
	...
	static int OnPointerClick(IntPtr L)
	{
		try
		{
			...
			//UIProfiler.Begin("UnityEngine.UI.Button.OnPointerClick");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.UI.Button obj = (UnityEngine.UI.Button)ToLua.CheckObject(L, 1, typeof(UnityEngine.UI.Button));
	...
	static int OnSubmit(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.UI.Button.OnSubmit");
#endif
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.UI.Button obj = (UnityEngine.UI.Button)ToLua.CheckObject(L, 1, typeof(UnityEngine.UI.Button));
	...
	static int op_Equality(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.UI.Button.op_Equality");
#endif
			ToLua.CheckArgsCount(L, 2);
	...
	static int get_onClick(IntPtr L)
	{
		...
		{
#if ENABLE_PROFILER || UNITY_EDITOR || UNITY_STANDALONE_WIN
			//UIProfiler.Begin("UnityEngine.UI.Button.onClick");
#endif
