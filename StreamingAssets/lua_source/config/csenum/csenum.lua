...
LuaInterfaceInjectType = {
	None = 0,
	After = 1,
	Before = 2,
	Replace = 4,
	ReplaceWithPreInvokeBase = 8,
	ReplaceWithPostInvokeBase = 16,
}
...
UnityEngineCameraFieldOfViewAxis = {
	Vertical = 0,
	Horizontal = 1,
}
...
UnityEngineCameraSceneViewFilterMode = {
	Off = 0,
	ShowFiltered = 1,
}

--UnityEngine.Camera.RenderRequestMode
UnityEngineCameraRenderRequestMode = {
	None = 0,
	ObjectId = 1,
	Depth = 2,
	VertexNormal = 3,
...
UnityEngineCameraRenderRequestOutputSpace = {
	ScreenSpace = -1,
	UV0 = 0,
	UV1 = 1,
	UV2 = 2,
